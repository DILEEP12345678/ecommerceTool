...
export default function AdminUsersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1a1c19] pb-24 sm:pb-6">
      <div className="sticky top-14 z-10 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-sm px-4 py-2.5 flex items-center justify-between">
        <h1 className="text-sm font-bold text-gray-900 dark:text-gray-100">Users</h1>
        {users !== undefined && (
        ...
        {users === undefined ? (
          ...
          <div className="space-y-3">
            {users.map((user: any) => {
              ...
              return (
                <div key={user._id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
                  <div className="px-4 py-3.5 flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 rounded-xl border border-gray-200 dark:border-gray-600 text-xs font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex-shrink-0"
                    >
                  ...
                  <div className="px-4 pb-3.5 flex flex-wrap gap-1.5">
                    {roles.length === 0 ? (
                      ...
                      return (
                        <span key={role} className="inline-flex items-center gap-1 text-xs font-semibold bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-0.5 rounded-full">
                  ...
                  {/* Inline editor */}
                  {isEditingThis && (
                    <div className="border-t border-gray-100 dark:border-gray-700 px-4 py-3 bg-gray-50 dark:bg-gray-700/50 space-y-3">
                      {/* Roles */}
                      <div>
                        <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">Roles</p>
                      ...
                      {pendingRoles.includes('collection_point_manager') && (
                        <div>
                          <p className="text-xs font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wider">Collection Point</p>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 rounded-xl border-2 border-gray-200 dark:border-gray-600 text-sm font-medium text-gray-800 dark:text-gray-200 placeholder-gray-400 dark:placeholder-gray-500 focus:border-primary-400 focus:outline-none bg-white dark:bg-gray-700"
                          />
                        </div>
                      )}
